...
<input type="radio" name="night3" class="cb" value="Primus Sydney" checked="true">Primus Sydney&nbsp;
  ...
  <input type="radio" name="night3" class="cb" value="Oaks Pacific">Hotel Oaks Pacific Blue Port Stephens
...
<input type="radio" name="night4" class="cb" value="Primus Sydney" checked="true">Primus Sydney&nbsp;
  ...
  <input type="radio" name="night4" class="cb" value="Rydges South Bank">Hotel Rydges South Bank
<script>
var slideIndex = 1;
...
<h2 style="text-align:center; font-family: agency FB">Night 5</h2>
<div class="container">
  <div class="mySlides4" align="middle">
    <div class="numbertext">1 / 6</div>
    <img src="primussydney - Copy.png" style="width:100%" >
  </div>
  <div class="mySlides4" align="middle">
  ...
  <div class="row">
    <div class="column">
      <img class="demo4 cursor" src="primussydney.png" style="width:100%" onclick="currentSlide4(1)" alt="Hotel Primus Sydney">
    </div>
    <div class="column">
      <img class="demo4 cursor" src="skyrider.png" style="width:100%" onclick="currentSlide4(2)" alt="Hotel Rider Motor Inn Blue Mountains">
    </div>
    <div class="column">
      <img class="demo4 cursor" src="crowneplaza.png" style="width:100%" onclick="currentSlide4(3)" alt="Hotel Crowne Plaza">
    </div>
    <div class="column">
      <img class="demo4 cursor" src="oakspacific.png" style="width:100%" onclick="currentSlide4(4)" alt="Hotel Oaks Pacific Blue Port Stephens">
    </div>
    <div class="column">
      <img class="demo4 cursor" src="panpacific.png" style="width:100%" onclick="currentSlide4(5)" alt="Hotel Pan Pacific">
    </div>    
    <div class="column">
      <img class="demo4 cursor" src="rydgessouthbank.png" style="width:100%" onclick="currentSlide4(6)" alt="Hotel Rydges South Bank">
    </div>
  </div>
</div>
<button type="button" id="booking4" class="block">Confirm Your Booking</button>
<input type="radio" name="night5" class="cb" value="Primus Sydney" checked="true">Primus Sydney&nbsp;
  <input type="radio" name="night5" class="cb" value="Sky Rider Motor Inn">Hotel Rider Motor Inn Blue Mountains&nbsp;
  <input type="radio" name="night5" class="cb" value="Crowne Plazza Hunter Valley">Hotel Crowne Plaza&nbsp;
  <input type="radio" name="night5" class="cb" value="Oaks Pacific">Hotel Oaks Pacific Blue Port Stephens
  <input type="radio" name="night5" class="cb" value="Pan Pacific">Hotel Pan Pacific&nbsp;
  <input type="radio" name="night5" class="cb" value="Rydges South Bank">Hotel Rydges South Bank
<script>
var slideIndex = 1;
...
function showSlides4(n) {
  ...
  var butto= document.getElementById("booking4");
  if (n > slides.length) {slideIndex = 1}
  if (n < 1) {slideIndex = slides.length}
  for (i = 0; i < slides.length; i++) {
      slides[i].style.display = "none";
  ...
  captionText.innerHTML = dots[slideIndex-1].alt;
  var keyi= dots[slideIndex-1].alt;
  butto.innerHTML='You Have Selected '+keyi+' For Night 5';
  localStorage.setItem("night5",keyi);
}
</script>

<h2 style="text-align:center; font-family: agency FB">Night 6</h2>
<div class="container">
  <div class="mySlides5" align="middle">
    <div class="numbertext">1 / 6</div>
    <img src="primussydney - Copy.png" style="width:100%" >
  </div>
  <div class="mySlides5" align="middle">
  ...
  <div class="row">
    <div class="column">
      <img class="demo5 cursor" src="primussydney.png" style="width:100%" onclick="currentSlide5(1)" alt="Hotel Primus Sydney">
    </div>
    <div class="column">
      <img class="demo5 cursor" src="skyrider.png" style="width:100%" onclick="currentSlide5(2)" alt="Hotel Rider Motor Inn Blue Mountains">
    </div>
    <div class="column">
      <img class="demo5 cursor" src="crowneplaza.png" style="width:100%" onclick="currentSlide5(3)" alt="Hotel Crowne Plaza">
    </div>
    <div class="column">
      <img class="demo5 cursor" src="oakspacific.png" style="width:100%" onclick="currentSlide5(4)" alt="Hotel Oaks Pacific Blue Port Stephens">
    </div>
    <div class="column">
      <img class="demo5 cursor" src="panpacific.png" style="width:100%" onclick="currentSlide5(5)" alt="Hotel Pan Pacific">
    </div>    
    <div class="column">
      <img class="demo5 cursor" src="rydgessouthbank.png" style="width:100%" onclick="currentSlide5(6)" alt="Hotel Rydges South Bank">
    </div>
  </div>
</div>
<button type="button" id="booking5" class="block">Confirm Your Booking</button>
<input type="radio" name="night6" class="cb" value="Primus Sydney" checked="true">Primus Sydney&nbsp;
  <input type="radio" name="night6" class="cb" value="Sky Rider Motor Inn">Hotel Rider Motor Inn Blue Mountains&nbsp;
  <input type="radio" name="night6" class="cb" value="Crowne Plazza Hunter Valley">Hotel Crowne Plaza&nbsp;
  <input type="radio" name="night6" class="cb" value="Oaks Pacific">Hotel Oaks Pacific Blue Port Stephens
  <input type="radio" name="night6" class="cb" value="Pan Pacific">Hotel Pan Pacific&nbsp;
  <input type="radio" name="night6" class="cb" value="Rydges South Bank">Hotel Rydges South Bank
<script>
var slideIndex = 1;
...
function showSlides5(n) {
  ...
  var butto= document.getElementById("booking5");
  if (n > slides.length) {slideIndex = 1}
  if (n < 1) {slideIndex = slides.length}
  for (i = 0; i < slides.length; i++) {
      slides[i].style.display = "none";
  ...
  captionText.innerHTML = dots[slideIndex-1].alt;
  var keyi= dots[slideIndex-1].alt;
  butto.innerHTML='You Have Selected '+keyi+' For Night 6';
  localStorage.setItem("night6",keyi);
}
</script>

<h2 style="text-align:center; font-family: agency FB">Night 7</h2>
<div class="container">
  <div class="mySlides6" align="middle">
    <div class="numbertext">1 / 6</div>
    <img src="primussydney - Copy.png" style="width:100%" >
  </div>
  <div class="mySlides6" align="middle">
  ...
  <div class="row">
    <div class="column">
      <img class="demo6 cursor" src="primussydney.png" style="width:100%" onclick="currentSlide6(1)" alt="Hotel Primus Sydney">
    </div>
    <div class="column">
      <img class="demo6 cursor" src="skyrider.png" style="width:100%" onclick="currentSlide6(2)" alt="Hotel Rider Motor Inn Blue Mountains">
    </div>
    <div class="column">
      <img class="demo6 cursor" src="crowneplaza.png" style="width:100%" onclick="currentSlide6(3)" alt="Hotel Crowne Plaza">
    </div>
    <div class="column">
      <img class="demo6 cursor" src="oakspacific.png" style="width:100%" onclick="currentSlide6(4)" alt="Hotel Oaks Pacific Blue Port Stephens">
    </div>
    <div class="column">
      <img class="demo6 cursor" src="panpacific.png" style="width:100%" onclick="currentSlide6(5)" alt="Hotel Pan Pacific">
    </div>    
    <div class="column">
      <img class="demo6 cursor" src="rydgessouthbank.png" style="width:100%" onclick="currentSlide6(6)" alt="Hotel Rydges South Bank">
    </div>
  </div>
</div>
<button type="button" id="booking6" class="block">Confirm Your Booking</button>
<input type="radio" name="night7" class="cb" value="Primus Sydney" checked="true">Primus Sydney&nbsp;
  <input type="radio" name="night7" class="cb" value="Sky Rider Motor Inn">Hotel Rider Motor Inn Blue Mountains&nbsp;
  <input type="radio" name="night7" class="cb" value="Crowne Plazza Hunter Valley">Hotel Crowne Plaza&nbsp;
  <input type="radio" name="night7" class="cb" value="Oaks Pacific">Hotel Oaks Pacific Blue Port Stephens
  <input type="radio" name="night7" class="cb" value="Pan Pacific">Hotel Pan Pacific&nbsp;
  <input type="radio" name="night7" class="cb" value="Rydges South Bank">Hotel Rydges South Bank
<script>
var slideIndex = 1;
...
function showSlides6(n) {
  ...
  var butto= document.getElementById("booking6");
  if (n > slides.length) {slideIndex = 1}
  if (n < 1) {slideIndex = slides.length}
  for (i = 0; i < slides.length; i++) {
      slides[i].style.display = "none";
  ...
  captionText.innerHTML = dots[slideIndex-1].alt;
  var keyi= dots[slideIndex-1].alt;
  butto.innerHTML='You Have Selected '+keyi+' For Night 7';
  localStorage.setItem("night7",keyi);
}
</script>

<h2 style="text-align:center; font-family: agency FB">Night 8</h2>
<div class="container">
  <div class="mySlides7" align="middle">
    <div class="numbertext">1 / 6</div>
    <img src="primussydney - Copy.png" style="width:100%" >
  </div>
  <div class="mySlides7" align="middle">
  ...
  <div class="row">
    <div class="column">
      <img class="demo7 cursor" src="primussydney.png" style="width:100%" onclick="currentSlide7(1)" alt="Hotel Primus Sydney">
    </div>
    <div class="column">
      <img class="demo7 cursor" src="skyrider.png" style="width:100%" onclick="currentSlide7(2)" alt="Hotel Rider Motor Inn Blue Mountains">
    </div>
    <div class="column">
      <img class="demo7 cursor" src="crowneplaza.png" style="width:100%" onclick="currentSlide7(3)" alt="Hotel Crowne Plaza">
    </div>
    <div class="column">
      <img class="demo7 cursor" src="oakspacific.png" style="width:100%" onclick="currentSlide7(4)" alt="Hotel Oaks Pacific Blue Port Stephens">
    </div>
    <div class="column">
      <img class="demo7 cursor" src="panpacific.png" style="width:100%" onclick="currentSlide7(5)" alt="Hotel Pan Pacific">
    </div>    
    <div class="column">
      <img class="demo7 cursor" src="rydgessouthbank.png" style="width:100%" onclick="currentSlide7(6)" alt="Hotel Rydges South Bank">
    </div>
  </div>
</div>
<button type="button" id="booking7" class="block">Confirm Your Booking</button>
<input type="radio" name="night8" class="cb" value="Primus Sydney" checked="true">Primus Sydney&nbsp;
  <input type="radio" name="night8" class="cb" value="Sky Rider Motor Inn">Hotel Rider Motor Inn Blue Mountains&nbsp;
  <input type="radio" name="night8" class="cb" value="Crowne Plazza Hunter Valley">Hotel Crowne Plaza&nbsp;
  <input type="radio" name="night8" class="cb" value="Oaks Pacific">Hotel Oaks Pacific Blue Port Stephens
  <input type="radio" name="night8" class="cb" value="Pan Pacific">Hotel Pan Pacific&nbsp;
  <input type="radio" name="night8" class="cb" value="Rydges South Bank">Hotel Rydges South Bank
<script>
var slideIndex = 1;
...
function showSlides7(n) {
  ...
  var butto= document.getElementById("booking7");
  if (n > slides.length) {slideIndex = 1}
  if (n < 1) {slideIndex = slides.length}
  for (i = 0; i < slides.length; i++) {
      slides[i].style.display = "none";
  ...
  captionText.innerHTML = dots[slideIndex-1].alt;
  var keyi= dots[slideIndex-1].alt;
  butto.innerHTML='You Have Selected '+keyi+' For Night 8';
  localStorage.setItem("night8",keyi);
}
</script>

<h2 style="text-align:center; font-family: agency FB">Night 9</h2>
<div class="container">
  <div class="mySlides8" align="middle">
    <div class="numbertext">1 / 6</div>
    <img src="primussydney - Copy.png" style="width:100%" >
  </div>
  <div class="mySlides8" align="middle">
  ...
  <div class="row">
    <div class="column">
      <img class="demo8 cursor" src="primussydney.png" style="width:100%" onclick="currentSlide8(1)" alt="Hotel Primus Sydney">
    </div>
    <div class="column">
      <img class="demo8 cursor" src="skyrider.png" style="width:100%" onclick="currentSlide8(2)" alt="Hotel Rider Motor Inn Blue Mountains">
    </div>
    <div class="column">
      <img class="demo8 cursor" src="crowneplaza.png" style="width:100%" onclick="currentSlide8(3)" alt="Hotel Crowne Plaza">
    </div>
    <div class="column">
      <img class="demo8 cursor" src="oakspacific.png" style="width:100%" onclick="currentSlide8(4)" alt="Hotel Oaks Pacific Blue Port Stephens">
    </div>
    <div class="column">
      <img class="demo8 cursor" src="panpacific.png" style="width:100%" onclick="currentSlide8(5)" alt="Hotel Pan Pacific">
    </div>    
    <div class="column">
      <img class="demo8 cursor" src="rydgessouthbank.png" style="width:100%" onclick="currentSlide8(6)" alt="Hotel Rydges South Bank">
    </div>
  </div>
</div>
<button type="button" id="booking8" class="block">Confirm Your Booking</button>
<input type="radio" name="night9" class="cb" value="Primus Sydney" checked="true">Primus Sydney&nbsp;
  <input type="radio" name="night9" class="cb" value="Sky Rider Motor Inn">Hotel Rider Motor Inn Blue Mountains&nbsp;
  <input type="radio" name="night9" class="cb" value="Crowne Plazza Hunter Valley">Hotel Crowne Plaza&nbsp;
  <input type="radio" name="night9" class="cb" value="Oaks Pacific">Hotel Oaks Pacific Blue Port Stephens
  <input type="radio" name="night9" class="cb" value="Pan Pacific">Hotel Pan Pacific&nbsp;
  <input type="radio" name="night9" class="cb" value="Rydges South Bank">Hotel Rydges South Bank
<script>
function handle1()
            {
                window.open("package 3.html","_blank");
            }
var slideIndex = 1;
...
function showSlides8(n) {
  ...
  var butto= document.getElementById("booking8");
  if (n > slides.length) {slideIndex = 1}
  if (n < 1) {slideIndex = slides.length}
  for (i = 0; i < slides.length; i++) {
      slides[i].style.display = "none";
  ...
  captionText.innerHTML = dots[slideIndex-1].alt;
  var keyi= dots[slideIndex-1].alt;
  butto.innerHTML='You Have Selected '+keyi+' For Night 9';
  localStorage.setItem("night9",keyi);
}
</script>
...
<?php
        ...
        if($_SERVER["REQUEST_METHOD"] == "POST")
        {
            ...
            $night_5=$_POST["night5"];
            $night_6=$_POST["night6"];
            $night_7=$_POST["night7"];
            $night_8=$_POST["night8"];
            $night_9=$_POST["night9"];
...
$sql5 = "INSERT INTO selects VALUES ('$userID', '$night_4', 4)";
 ...
 $sql6 = "INSERT  INTO selects VALUES ('$userID', '$night_5', 5)";
...
$sql7 = "INSERT INTO selects VALUES ('$userID', '$night_6', 6)";
 ...
 $sql8 = "INSERT  INTO selects VALUES ('$userID', '$night_1', 7)";
 ...
 $sql9 = "INSERT  INTO selects VALUES ('$userID', '$night_1', 8)";
 ...
 $sql10 = "INSERT  INTO selects VALUES ('$userID', '$night_1', 9)";
